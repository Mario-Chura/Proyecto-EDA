/**
 * esta clase es la implementación del árbol avl con el método de inserción que permite agregar un nuevo nodo al árbol
 */
public class AVLTree<TYPE extends Comparable<? super TYPE>> {
	...
	public Node<TYPE> rightRotate(Node<TYPE> current) {
		...
		// Actualizar la altura después de la rotación
	...
	// Este método gira a la izquierda el movimiento de cabeza desequilibrado
	...
	public Node<TYPE> insert(Node<TYPE> current, TYPE value) {
		...
		// Verifica el saldo después de agregar el nuevo nodo para verificar si el árbol se convirtió desequilibrada (menor que -1 o mayor que 1)
